...
public class Rmendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * and normally should not be changed.
   */
  public static final String DEFAULT_BASE_URL = RMClientConstants.DEFAULT_ROOT_URL + DEFAULT_SERVICE_PATH;
   ...
   *
   * @param content the {@link com.arshu.roommate.server.endpoint.rmendpoint.model.AEMate}
   * @return the request
   */
  public DoLogin doLogin(com.arshu.roommate.server.endpoint.rmendpoint.model.AEMate content) throws java.io.IOException {
    DoLogin result = new DoLogin(content);
    initialize(result);
    return result;
  }

  public class DoLogin extends RmendpointRequest<com.arshu.roommate.server.endpoint.rmendpoint.model.AEMate> {
     ...
     * @since 1.13
     */
    protected DoLogin(com.arshu.roommate.server.endpoint.rmendpoint.model.AEMate content) {
      super(Rmendpoint.this, "POST", REST_PATH, content, com.arshu.roommate.server.endpoint.rmendpoint.model.AEMate.class);
    }
  ...
  public class GetAllRooms extends RmendpointRequest<com.arshu.roommate.server.endpoint.rmendpoint.model.AERoomCollection> {

    private static final String REST_PATH = "aeroomcollection";
    ...
    protected GetAllRooms() {
      super(Rmendpoint.this, "GET", REST_PATH, null, com.arshu.roommate.server.endpoint.rmendpoint.model.AERoomCollection.class);
    }
  ...
  public class MatesJoinRoom extends RmendpointRequest<com.arshu.roommate.server.endpoint.rmendpoint.model.AERoom> {
    ...
    protected MatesJoinRoom(com.arshu.roommate.server.endpoint.rmendpoint.model.JoinRoomRequest content) {
      super(Rmendpoint.this, "POST", REST_PATH, content, com.arshu.roommate.server.endpoint.rmendpoint.model.AERoom.class);
    }
   ...
   * @return the request
   */
  public RegisterMate registerMate(com.arshu.roommate.server.endpoint.rmendpoint.model.AEMate content) throws java.io.IOException {
    RegisterMate result = new RegisterMate(content);
    initialize(result);
    return result;
  }

  public class RegisterMate extends RmendpointRequest<com.arshu.roommate.server.endpoint.rmendpoint.model.AEMate> {
     ...
     * @since 1.13
     */
    protected RegisterMate(com.arshu.roommate.server.endpoint.rmendpoint.model.AEMate content) {
      super(Rmendpoint.this, "POST", REST_PATH, content, com.arshu.roommate.server.endpoint.rmendpoint.model.AEMate.class);
    }
  ...
  public static final class Builder extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient.Builder {
    ...
    public Builder(com.google.api.client.http.HttpTransport transport, com.google.api.client.json.JsonFactory jsonFactory,
      ...
      super(
          transport,
          jsonFactory,
          RMClientConstants.DEFAULT_ROOT_URL,
