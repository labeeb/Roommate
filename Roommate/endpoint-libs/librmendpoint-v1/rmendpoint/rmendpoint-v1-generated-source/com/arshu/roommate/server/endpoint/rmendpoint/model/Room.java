...
public final class Room extends com.google.api.client.json.GenericJson {
  ...
  private java.util.List<Mate> allMates;

  static {
    // hack to force ProGuard to consider Mate used, since otherwise it would be stripped out
    // see http://code.google.com/p/google-api-java-client/issues/detail?id=528
    com.google.api.client.util.Data.nullOf(Mate.class);
  }
   ...
   */
  public java.util.List<Mate> getAllMates() {
    return allMates;
  }
   ...
   */
  public Room setAllMates(java.util.List<Mate> allMates) {
